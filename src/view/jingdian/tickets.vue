<template>
    <div id="pageContainer" ref="container">
        ...
        <div class="tip">产品预订</div>
        <div class="mid">
            <div class="list">
                <div class="item flex fcen spb" v-for="(item,index) in list" :key="'t' + index">
                    <div>
                        <div class="flex">
...
import { jdInfo } from '../../api/jingdian';
        ...
        getData() {
            ...
            jdInfo({ scenicSpotId: this.id }).then(res => {
                ...
                if (res.resultCode == 200 && res.resultData) {
                    ...
                    this.list = res.resultData.ticketsVOList || [];
